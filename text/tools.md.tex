...
\docframe{
\docparwithoutframe{The documentation of the \noun{IceCube Simulation Framework} can be found at \url{http://software.icecube.wisc.edu/documentation/}, the source code at \url{http://code.icecube.wisc.edu/projects/icecube/browser/IceCube/meta-projects/simulation}.}\medskip
