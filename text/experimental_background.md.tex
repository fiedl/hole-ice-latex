...
\begin{figure}[htbp]
  ...
  \subcaptionbox{The components of the module are contained within a glasss sphere that can withstand high pressures. The space inbetween is filled with a gel to avoid optical effects at the medium boundaries. Image source: \cite{gallerynoharness}}{\includegraphics[width=0.35\textwidth]{img/DOMNoHarnessWhiteback_lg-gallery-2013}}
