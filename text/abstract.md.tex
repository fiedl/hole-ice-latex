...
The hole-ice approximation, which is used in the standard simulation chain is found to disagree with all existing direct-propagation tools and should be recalculated with a new direct-simulation run.
