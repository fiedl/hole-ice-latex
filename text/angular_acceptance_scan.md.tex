...
\begin{figure}[htbp]
  \subcaptionbox{Shoot photons from fixed start positions (pencil beam)}{\halfimage{angular-acceptance-coordinates-quie8Oof}}\hfill
  \subcaptionbox{Shoot photons from planes (plane wave)}{\halfimage{angular-acceptance-coordinates-plane-waves-Ii2nieki}}
  \caption{Angular-acceptance scan}
  \label{fig:label}
\end{figure}
