...
\noun{Pythagorean Theorem} to calculate the distance of the photon from
...
Both methods are described in section \ref{sec:intersections}. The
...
As a rule of thumb, using values from
