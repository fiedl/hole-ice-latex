...
\begin{figure}[htbp]
  \subcaptionbox{\steamshovel display of the simulation scenario for $\eta = \pi$. The photons are started from a plane on the left-hand side of the image.}{\halfimage{asymmetry-example-steamshovel}}\hfill
...
In this example simulation, the cylinder is shifted relative to the
