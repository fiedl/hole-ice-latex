...
\sourcepar{The implementation of this consistency check can be found in \issue{67}, \issue{47}, and \issue{22}.}
...
\sourcepar{The implementation of this consistency check can be found in \issue{66}.}
...
\sourcepar{The implementation of this consistency check can be found in \issue{71}.}
...
\begin{figure}[htbp]
  ...
  \caption{\noun{Steamshovel} event display of a simulation of a plane wave of photons propagating towards a hole-ice cylinder. The scattering length within the hole-ice cylinder is different from the scattering length within the surrounding bulk ice.}
  \label{fig:An7ik8pu}
\end{figure}
...
In the vicinity of the hole-ice-cylinder radius, there should be a smooth transition. \todo{The technical reason is that the budget code handles both media here; TODO: physical explanation.}
...
\begin{figure}[htbp]
  \subcaptionbox{All data points}{\includegraphics[width=0.32\linewidth]{img/cross-check-71-scatter}}\hfill
  \subcaptionbox{Averaged for bins of a width of  $10\cm$}{\includegraphics[width=0.32\linewidth]{img/cross-check-71-bins}}\hfill
  \subcaptionbox{Magnification of the vincinity of the hole-ice border}{\includegraphics[width=0.32\linewidth]{img/cross-check-71-bins-vicinity}}
