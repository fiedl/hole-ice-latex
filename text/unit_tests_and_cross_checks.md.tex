...
\begin{figure}[htbp]
  ...
  \hfill
  \subcaptionbox{For different hole-ice configurations, the simulation results in different photon-arrival-time distributions. The dashed lines indicate the mean arrival times.}{\includegraphics[width=.48\linewidth]{img/arrival-time-distribution-eipau6Ag}}
