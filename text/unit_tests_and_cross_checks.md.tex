...
In order to test the qualit

- one sees three different effects
- less photons because scattered away
- later, because scattering around takes time
- the left-hand side is less steep, because with more scattering points there is a larger number of possible paths, i.e. the arrival time is more distributed
- predict exact behaviour is more involved
- estimation based on the mean scattering angle and the radius of the hole-ice cylinder: to observe delay in the order of 100ns, increase the hole-ice radius by the order of metres.
- no realistic scenario as drill hole is only about 50cm in diameter, but simulation

- arrival-time distribution #91, abschätzung 2018-07-18
